...
class FeedStore {
    private typealias DeletionCompletion = (Error?) -> Void
    private typealias InsertionCompletion = (Error?) -> Void
...
final class CacheFeedUseCaseTests: XCTestCase {
    ...
    private func uniqueItem() -> FeedItem {
        FeedItem.init(id: .init(), description: "any", location: "any", imageURL: anyURL())
    }
